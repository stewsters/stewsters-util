...
public class NameGen {
    ...
    public static String randomMaleFirstName() {
        return capitalize(MathUtils.rand(maleFirstName).toLowerCase());
    }

    public static String randomFemaleFirstName() {
        return capitalize(MathUtils.rand(femaleFirstName).toLowerCase());
    }

    public static String randomLastName() {
        return capitalize(MathUtils.rand(aLastName).toLowerCase());
    }
